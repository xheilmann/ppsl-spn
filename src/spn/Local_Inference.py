...
from spn.structure.leaves.parametric.Inference import discrete_likelihood, discrete_log_likelihood
...
_node_likelihood = {Sum: sum_likelihood, Product: prod_likelihood, Bernoulli: discrete_likelihood}
...
def likelihood(node, data, dtype=np.float64, node_likelihood=None, lls_matrix=None, debug=False, **kwargs):
...
def log_likelihood(
        node, data, dtype=np.float64, node_log_likelihood=None, lls_matrix=None, debug=False, **kwargs):
